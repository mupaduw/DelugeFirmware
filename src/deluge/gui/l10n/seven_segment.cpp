...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_TIME_STRETCH_OPTIONAL, "STRETCH"},
        {STRING_FOR_COMMUNITY_FEATURE_TIME_STRETCH_ON, "TSON"},
        {STRING_FOR_COMMUNITY_FEATURE_TIME_STRETCH_OFF, "TSOF"},
